...
<button id="back"><a href="adminvehicle.php">HOME</a></button> 
 ...
 <div class="main">
        ...
        <form id="register"  action="upload.php" method="POST" enctype="multipart/form-data">    
            ...
            <br>
            <input type ="text" name="carownername"
            id="name" placeholder="Enter Car Owner Name" required>
            <br><br>

            <label>Car Owner ph no : </label>
            <br>
            <input type ="text" name="carownerphno"
            id="name" placeholder="Enter Car Owner ph no" required>
            <br><br>
